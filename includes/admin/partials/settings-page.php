	...
	<div class="drillnav-settings-layout">
		...
		<div class="drillnav-settings-main">
			...
			<nav class="nav-tab-wrapper drillnav-tab-nav" aria-label="<?php esc_attr_e( 'Settings sections', 'drillnav-drilldown-navigation' ); ?>">
				...
				<a href="#tab-blog" class="nav-tab" data-tab="blog"><?php esc_html_e( 'Blog', 'drillnav-drilldown-navigation' ); ?></a>
				<a href="#tab-woocommerce" class="nav-tab" data-tab="woocommerce"><?php esc_html_e( 'WooCommerce', 'drillnav-drilldown-navigation' ); ?></a>
			...
			<form method="post" action="options.php">
				...
				<?php /* ── Tab: Blog ── */ ?>
				<div id="tab-blog" class="drillnav-tab-panel" hidden>
